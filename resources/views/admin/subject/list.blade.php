                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ url('admin/subject/add') }}" class="btn btn-primary">Add New
                                    Subjects</a></li>
                        </ol>
                    </div>
                </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <a href="{{ url('subject/list') }}" class="btn btn-success"
                                        ...
                                        @foreach ($getRecord as $valueClass)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{url('admin/subject/edit',$valueClass->id)}}" class="btn btn-primary">Edit</a>
                                                    <a href="{{url('admin/subject/delete',$valueClass->id)}} " class="btn btn-danger">Delete</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
