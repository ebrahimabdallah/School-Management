                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-12">
                                <ol class="breadcrumb float-sm-right">
                                    <a href="{{ url('admin/teacher/list') }}" class="btn btn-primary">Admins</a>
                                </ol>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group  col-md-6">
                                                    ...
                                                    <input type="text" name="martial_status" class="form-control"
                                                        id="martial_status" placeholder="martial_status">
                                                </div>
                                                ...
                                                <div class="form-group  col-md-6">
                                                    ...
                                                    <input type="experience" name="experience" class="form-control"
